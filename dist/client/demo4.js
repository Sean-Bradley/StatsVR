...
controllerGrip0.addEventListener("connected", (e) => { controller0.userData.gamepad = e.data.gamepad; });
const controller1 = renderer.xr.getController(1);
scene.add(controller1);
const controllerGrip1 = renderer.xr.getControllerGrip(1);
controllerGrip1.addEventListener("connected", (e) => { controller1.userData.gamepad = e.data.gamepad; });
...
const swordLeftHandGuard = new THREE.Mesh(new THREE.CylinderGeometry(0.005, 0.05, 0.2, 6), swordMaterial);
swordLeftHandGuard.geometry.rotateX(Math.PI / 2);
controller0.add(swordLeftHandGuard);
const swordRight = new THREE.Mesh(new THREE.BoxGeometry(0.03, 4.0, 0.03), swordMaterial);
...
const swordRightHandGuard = new THREE.Mesh(new THREE.CylinderGeometry(0.005, 0.05, 0.2, 6), swordMaterial);
